...
namespace adaptive
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            Itableview_Bindings
        {
            ...
            {
                if (lineNumber == 15 && columnNumber == 48)
                {
                ...
                else if (lineNumber == 18 && columnNumber == 50)
                {
                ...
                else if (lineNumber == 21 && columnNumber == 51)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 22 && columnNumber == 51)
                {
                    isobj9TextDisabled = true;
                }
                else if (lineNumber == 23 && columnNumber == 49)
                {
            ...
            private void UpdateTwoWay_7_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.emp != null)
                        {
                            this.dataRoot.emp.gender = this.obj7.Text;
                        }
                    }
                }
            }
